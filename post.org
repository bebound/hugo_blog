...
You can found =textcnn.ipynb= [[https://github.com/bebound/ML-ipynb][here]].
...
- [[https://github.com/facebookresearch/visdom][Visdom]]
  ...
  It's a visualization tool. One of the most common usage is to show some metrics during train. It's more convenient to use it rather than generate graph manually by matplotlib. Besides =reward= and =mean_q=, these variable are also useful when debugging: total frames, TD-error, loss and action_distribution.
