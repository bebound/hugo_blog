...
In the fixed version, =dotspacemacs-major-mode-emacs-leader-key= bind to =M-<return>=, and this override org mode's binding. Finally meta return becomes leader key again.
