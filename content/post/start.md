...
title = "Architectures"
author = ["KK"]
lastmod = 2019-05-11T22:36:11+08:00
...
### <span class="org-todo done DONE">DONE</span> Create Node Benchmark in Py2neo {#create-node-benchmark-in-py2neo}
...
### <span class="org-todo done DONE">DONE</span> CSRF in Django {#csrf-in-django}
...
### <span class="org-todo done DONE">DONE</span> Deploy Nikola OrgMode on Travis {#deploy-nikola-orgmode-on-travis}
...
### <span class="org-todo done DONE">DONE</span> Enable C Extension for gensim on Windows {#enable-c-extension-for-gensim-on-windows}
...
### <span class="org-todo done DONE">DONE</span> Using Chinese Characters in Matplotlib {#using-chinese-characters-in-matplotlib}
...
### <span class="org-todo done DONE">DONE</span> Python Dictionary Implementation {#python-dictionary-implementation}
...
### <span class="org-todo done DONE">DONE</span> Circular Import in Python {#circular-import-in-python}
...
### <span class="org-todo done DONE">DONE</span> Some Useful Shell Tools {#some-useful-shell-tools}
...
-    [pt](https://github.com/monochromegane/the%5Fplatinum%5Fsearcher)
